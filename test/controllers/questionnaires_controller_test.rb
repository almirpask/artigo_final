...
class QuestionnairesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post questionnaires_url, params: { questionnaire: { question: @questionnaire.question, teacher_id: @questionnaire.teacher_id } }
    end
  ...
  test "should update questionnaire" do
    patch questionnaire_url(@questionnaire), params: { questionnaire: { question: @questionnaire.question, teacher_id: @questionnaire.teacher_id } }
