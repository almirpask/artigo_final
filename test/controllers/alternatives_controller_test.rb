...
class AlternativesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alternative" do
    assert_difference('Alternative.count') do
      post alternatives_url, params: { alternative: { answer: @alternative.answer, description: @alternative.description, questionnaire_id: @alternative.questionnaire_id } }
    end
  ...
  test "should update alternative" do
    patch alternative_url(@alternative), params: { alternative: { answer: @alternative.answer, description: @alternative.description, questionnaire_id: @alternative.questionnaire_id } }
